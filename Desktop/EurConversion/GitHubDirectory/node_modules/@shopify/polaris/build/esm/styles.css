@charset "UTF-8";
:root { --polaris-version-number: '10.0.0'; }
...
.Polaris-Avatar__Image { position: absolute; top: 50%; left: 50%; width: 100%; height: 100%; border-radius: var(--p-border-radius-half); transform: translate(-50%, -50%); object-fit: cover; }
...
.Polaris-DataTable__FixedFirstColumn { position: absolute; background: var(--p-surface); z-index: 3; border-spacing: 0; left: 0; }

@media (max-width: 47.99688em) { .Polaris-DataTable__FixedFirstColumn { z-index: 1; } }

.Polaris-DataTable__FixedFirstColumn.Polaris-DataTable--separate:is(table) th, .Polaris-DataTable__FixedFirstColumn.Polaris-DataTable--separate:is(th) { border-right: var(--p-border-divider); }
...
@media (min-width: 30.625em) { .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell, .Polaris-IndexTable__Table--scrolling .Polaris-IndexTable__TableHeading--second { filter: drop-shadow(0.0625rem 0 0 var(--p-divider)); } }
...
@media (min-width: 30.625em) { .Polaris-IndexTable__TableHeading--second:not(.Polaris-IndexTable__TableHeading--unselectable) { position: sticky; z-index: auto; left: 0; } }
...
@media (min-width: 30.625em) { .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell { position: sticky; z-index: var(--pc-index-table-sticky-cell); } }
